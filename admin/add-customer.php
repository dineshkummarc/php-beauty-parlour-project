<?php
	...
	if(!strlen($_SESSION['bpmsaid'])) {
		...
		if(isset($_POST['submit'])) {
			...
			$mobilenum	= $con->real_escape_string($_POST['mobilenum']);
			$gender		= $con->real_escape_string($_POST['gender']); 
			$query = mysqli_query($con, "insert into  tblcustomers(Name,Email,MobileNumber,Gender,Type) value('$name','$email','$mobilenum','$gender','1')");
			if($query) {
...
<head>
    <title>BTMS | Add Customers</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
                                ...
                                <div class="form-group"> <label for="phone">Mobile Number</label> <input type="tel" class="form-control" id="mobilenum" name="mobilenum" placeholder="Mobile Number" value="" required="true" maxlength="11" pattern="[0-9]+" data-error="please write phone number"> </div>
