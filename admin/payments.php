							...
							?>	<tr>
									...
									<?php
										...
										foreach($ser_array as $ser_id) {
											...
											echo '	<p style="font-size:12px;color:#888">Cost: Tk.'. $service_info['Cost'] .'</p>';
											echo '</div>';
									...
									<td>
										Tk.<?= $total_cost ?>
									<?php if($row['Type'] == 2) { ?>
										<p style="font-size:12px;color:#888">VIP Discount: 5%</p>
										<div style="height:1px;background: #333">&nbsp;</div>
										<p>Subtotal: Tk.<?= $total_cost-($total_cost*.05) ?></p>
									<?php } ?>
									</td>
                                    <td>
