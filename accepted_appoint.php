...
<body>
	...
	<section class="ftco-section ftco-pricing text-center">
          ...
          <div>
          <h3 class="display-5 text-danger">
		          If your name is not there, then your appointment has been cencelled due to conflict time or some other reason. If You have any queries feel free to call us.
		          <strong>Phone: 01798050944</strong>
		          Thank  You!
		      </h3> 
		    </div>
			 </div>
